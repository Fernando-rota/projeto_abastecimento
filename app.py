...
def carregar_dados(abastecimento_path):
    ...
    df_externo['Tipo Combustivel'] = df_externo['Tipo Combustivel'].astype(str).str.strip().str.upper()
...
def main():
    ...
    if arquivo:
        ...
        combustiveis = sorted(set(df_interno['Tipo Combustivel'].unique()).union(set(df_externo['Tipo Combustivel'].unique())))
